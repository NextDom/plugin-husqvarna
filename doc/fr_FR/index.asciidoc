...
image::../images/husqvarna_screenshot3.jpg[align="center"]
...
image::../images/husqvarna_screenshot6.jpg[align="center"]

==== Informations visibles :
[horizontal]
- *Etat* : état du husqvarna. C'est une commande de type info binary. Elle est active durant 10 secondes sur reception de fichier.
...
Comme port (généralement 21), il faut mettre le port husqvarna qui a été renseigné dans la page de configuration du plugin (8888 par defaut).
